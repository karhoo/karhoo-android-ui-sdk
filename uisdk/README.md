...
dependencies {
    ...
    implementation 'com.github.karhoo.karhoo-android-ui-sdk:uisdk-adyen:1.7.1'

    //The -braintree dependency contains the Braintree integration:
    implementation 'com.github.karhoo.karhoo-android-ui-sdk:uisdk-braintree:1.7.1'

    //The -full dependency contains both payment providers and it's up to you which payment provider you shall use:
    implementation 'com.github.karhoo.karhoo-android-ui-sdk:uisdk-full:1.7.1'
