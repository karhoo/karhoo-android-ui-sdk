...
class PastRideCardPresenterTest {
    ...
    fun `when state is bound then display cancelled icon with cancelled text`() {
        ...
        verify(view).displayState(R.drawable.uisdk_ic_trip_cancelled, R.string.kh_uisdk_ride_state_cancelled, R.color.kh_uisdk_text_secondary)
    }
    ...
    fun `when state is bound then display completed icon with completed text`() {
        ...
        verify(view).displayState(R.drawable.uisdk_ic_trip_completed, R.string.kh_uisdk_ride_state_completed, R.color.kh_uisdk_text_secondary)
    }
