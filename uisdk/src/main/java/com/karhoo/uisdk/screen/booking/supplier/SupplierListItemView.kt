...
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.categoryText
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.etaText
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.fareTypeText
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.loadingIcon
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.logoImage
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.pickupTypeText
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.priceText
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.supplierNameText
import kotlinx.android.synthetic.main.uisdk_view_supplier_item.view.supplierProgressBar
import java.util.Currency

class SupplierListItemView @JvmOverloads constructor(context: Context,
                                                     attrs: AttributeSet? = null,
                                                     defStyleAttr: Int = 0)
    : LinearLayout(context, attrs, defStyleAttr) {

    var itemLayout: Int = R.layout.uisdk_view_supplier_item
    ...
    private fun getListItemLayout(context: Context, attr: AttributeSet?, defStyleAttr: Int): Int {
        ...
        val layout = typedArray.getResourceId(R.styleable.SupplierListItem_layout, R
                .layout.uisdk_view_supplier_item)
        typedArray.recycle()
        return layout
    }
