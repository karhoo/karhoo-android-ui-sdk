...
class CheckoutActivity : BaseActivity(), WebViewActions {
    ...
    companion object {
        ...
        const val BOOKING_CHECKOUT_PREBOOK_SKIP_RIDE_DETAILS_KEY = "PREBOOK_TRIP_SKIP_RIDE_DETAILS_KEY"
        const val BOOKING_CHECKOUT_PREBOOK_QUOTE_TYPE_KEY = "PREBOOK_QUOTE_TYPE_KEY"
        const val BOOKING_CHECKOUT_PREBOOK_QUOTE_KEY = "PREBOOK_QUOTE_KEY"
